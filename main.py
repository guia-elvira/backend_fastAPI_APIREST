...
# CRUD: Read (lectura) GET ALL: Leeremos todos los archivos que haya en la db
...
def crear_curso(curso:Curso):
    curso.id = str(uuid.uuid4()) # Usamos UUID para generar una db única e irrepetible
...
# CRUD: Update (Actualización/Modificar) PUT: Modificaremos un recurso que coincida con el ID que mandemos
